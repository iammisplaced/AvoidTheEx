...
def play(screen, skill):
	...
	while not done:
		if game.cur == "play":
			...
			if yourTime < bestTimeList[0]:
				prevHighScoreText[LEVEL-1][2] = prevHighScoreText[LEVEL-1][1]
				prevHighScoreText[LEVEL-1][1] = prevHighScoreText[LEVEL-1][0]
				prevHighScoreText[LEVEL-1][0] = yourTime
				prevHighScoreText[LEVEL-1] = str(prevHighScoreText[LEVEL-1])+'\n'
				updateScoreFile(prevHighScoreText)
			elif yourTime < bestTimeList[1]:
				prevHighScoreText[LEVEL-1][2] = prevHighScoreText[LEVEL-1][1]
				prevHighScoreText[LEVEL-1][1] = yourTime
				prevHighScoreText[LEVEL-1] = str(prevHighScoreText[LEVEL-1])+'\n'
				updateScoreFile(prevHighScoreText)
			elif yourTime < bestTimeList[2]:
